...
# Set directory pataah

dirPath = '//Users//parinpatel//Documents//IST  (NLP) //Final Project//Users//parinpatel//Documents//IST  (NLP) //Final Project//FinalProjectData//kagglemoviereviews'
...
if __name__ == '__main__': 
    if (len(sys.argv) != 3):
        ...
        def processkaggle(dirPath,limitStr):
            #convert the limit argument from a string to an int limit = int(limitStr)
            limit = int(limitStr)
            
            os.chdir(dirPath)
            f = open('//Users//parinpatel//Documents//IST  (NLP) //Final Project//Users//parinpatel//Documents//IST  (NLP) //Final Project//FinalProjectData//corpus//train.tsv', 'r')
            # loop over lines in the file and use the first limit  
            phrasedata = []
            for line in f:
                if (not line.startswith('Phrase')):# ignore the first line . read all lines 
...
newstopwords = [word for word in stopwords if word not in ['not', 'no', 'can','don', 't', 'll']]
...
# define a feature definition function
# bag of words  
...
# define features - unigram baseline
...
#Define function - POS tag feature
...
#define feature - Sentiment Lexicon: Subjectivity Count features
...
SLpath = "//Users//parinpatel//Documents//IST  (NLP) //Final Project//FinalProjectData//kagglemoviereviews//SentimentLexicons//subjclueslen1-HLTEMNLP05.tff"
...
##Define function  - bigram  features  
...
def processkaggle(dirPath,limitStr):
    # convert the limit argument from a string
    limit = int(limitStr)
    os.chdir(dirPath)
...
#Get test csv file
  f = open('//Users//parinpatel//Documents//IST  (NLP) //Final Project//Users//parinpatel//Documents//IST  (NLP) //Final Project//FinalProjectData//corpus//test.tsv', 'r')
  # loop over lines in the file and use the first limit of them
  testphrasedata = []
  for line in f:
    # ignore the first line starting with Phrase and read all lines
...
## Section 4: Running NLTK Naiive Bayes - Getting Accuracy Calc
...
#test file creation for predict label using classifier
...
#limit # of phrases  and processes fukes
#then  trains the review sentiment classifier.
